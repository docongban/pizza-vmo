...
public class LoginController {
	...
	@Transactional
	@PostMapping("/history/evulate/{id}")
	public String evulate(@PathVariable("id") int id, @ModelAttribute("evulate") Evulate evulate, HttpServletRequest request){
		this.evulateService.saveEvulate(evulate,id);
		this.orderAccountRepository.updateStatusEvulate(id);
		return "redirect:" + request.getHeader("Referer");
	}
}